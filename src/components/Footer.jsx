        ...
        <div className='max-w-[1400px] mx-auto grid grid-cols-2 md:grid-cols-6 border-b-2 border-gray-600 px-4 py-8'>
            ...
            <div className='col-span-2 py-8 md:pt-2'>
                ...
                <form className='flex flex-col sm:flex-row'>
                    <input type="email" placeholder='Enter Email...' className='w-full p-2 mr-4 mb-4' />
                    <button className='border py-2 px-3 rounded-md mb-4 p-2'>Subscribe</button>
                </form>
            </div>
        </div>

        <div className='flex flex-col sm:flex-row text-center max-w-[1400px] px-2 py-4 mx-auto justify-between text-gray-500'>
